...
export default function Home() {
  return (
    <main className="bg-brandCream text-gray-800 font-sfpro">

      {/* NAVBAR */}
      <nav className="flex justify-between items-center p-4 shadow bg-brandWhite sticky top-0 z-50">
        <h1 className="text-xl font-bold text-brandGreen">SNT</h1>
        <button className="bg-brandGreen text-brandWhite px-4 py-2 rounded-lg hover:opacity-90 transition">
          Order Now
        </button>
      </nav>
      ...
      <section className="text-center py-16 px-6">
        <h1 className="text-5xl font-bold leading-tight text-brandGreen">
        ...
        <button className="mt-6 bg-brandGreen text-brandWhite px-6 py-3 rounded-xl text-lg hover:opacity-90 transition">
          Shop Now
        </button>
      </section>
      ...
      <section className="px-6 py-12">
        <h2 className="text-3xl font-semibold text-center mb-10 text-brandGreen">
          Our Products
        </h2>
        ...
        >
          <SwiperSlide>
            <div className="bg-white p-6 rounded-2xl shadow text-center">
              ...
              <p className="text-brandGreen font-bold">₹120/kg</p>
          ...
          <SwiperSlide>
            <div className="bg-white p-6 rounded-2xl shadow text-center">
              ...
              <p className="text-brandGreen font-bold">₹140/kg</p>
              <p className="mt-2 text-gray-600">
          ...
          <SwiperSlide>
            <div className="bg-white p-6 rounded-2xl shadow text-center">
              ...
              <p className="text-brandGreen font-bold">₹130/kg</p>
              <p className="mt-2 text-gray-600">
      ...
      <section className="px-6 py-12 max-w-4xl mx-auto text-gray-800 leading-relaxed">
        <h2 className="text-3xl font-semibold mb-6 text-center text-brandGreen">🌿 About Jaggery Powder</h2>
        <p>
          Jaggery powder is a natural, unrefined sweetener made from sugarcane juice, known for its rich taste and health benefits...
        </p>

        <h3 className="text-2xl font-bold mt-8 text-brandGreen">🌾 SNT Nimmy’s Jaggery Powder</h3>
        ...
        <h3 className="text-2xl font-bold mt-8 text-brandGreen">🍯 Cane Jaggery Balls</h3>
        <ul className="list-disc list-inside mt-2">
        ...
        <h3 className="text-2xl font-bold mt-8 text-brandGreen">🪔 Achu Vellam (Moulded Jaggery)</h3>
        <ul className="list-disc list-inside mt-2">
        ...
        <h3 className="text-2xl font-bold mt-8 text-brandGreen">💛 Our Promise</h3>
        <p>
      ...
      {/* CONTACT */}
      <section className="py-12 px-6 text-center bg-brandWhite">
        <h2 className="text-3xl font-semibold mb-4 text-brandGreen">Contact Us</h2>
        <p>📞 +91 90804 65096</p>
        <p>📍 Madurai, Tamil Nadu</p>

        <button className="mt-6 bg-brandGreen text-brandWhite px-6 py-3 rounded-xl hover:opacity-90 transition">
          WhatsApp Us
        </button>
      </section>

      {/* FOOTER */}
      <footer className="bg-brandGreen text-white text-center p-4">
